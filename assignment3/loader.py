...
class Diabetes(DataLoader):
    def __init__(self, path='data/diabetes.csv', verbose=False, seed=1):
        super().__init__(path, verbose, seed)
...
class Mushrooms(DataLoader):
    def __init__(self, path='data/mushrooms.csv', verbose=False, seed=1):
        super().__init__(path, verbose, seed)
